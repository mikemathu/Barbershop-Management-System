...
if(isset($_POST['submit'])){
    ...
    try{
        ...
        $message->originator = '+254798827450';
...
<form action="sms.php" method="POST">
    ...
    <input type="text" name="recipient" id="recipient" hidden value="+254798827450">
    <!-- <label for="sms">Write SMS</label> -->
    <textarea name="sms" id="sms" cols="30" rows="10" hidden>Good sunday overe here</textarea>
