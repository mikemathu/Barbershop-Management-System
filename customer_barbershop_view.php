...
<table>
	  ...
	  echo "<br>".$i. ". ";
		 ...
		 <a href= "customer_view_barbershop.php?uid=<?php echo $row['Reg_id'];?>"<?php echo $row['Reg_id'];?>>UserName:	  <?php echo $row['Username']; ?>&nbsp <br><br> Mobile:<?php echo $row['Mobile']; ?></a><br>
